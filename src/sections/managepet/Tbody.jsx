...
import { dogList } from "../../constants/app";
 ...
 return (
  <>
   <tbody>
    {dogList.map((list) => {
     return (
      <tr className="border-b dark:border-gray-700" key={list.id}>
       <th
        scope="row"
       ...
       <td className="px-4 py-3">{list.breed}</td>
       <td className="px-4 py-3">{list.age}</td>
       <td className="px-4 py-3 max-w-[12rem] truncate">{list.description}</td>
       <td className="px-4 py-3">{list.gender}</td>
       <td className="px-4 py-3 flex items-center justify-end">
        <button
         id={`${list.id}-dropdown-button`}
         data-dropdown-toggle={`${list.id}-dropdown`}
        ...
        >
         <ul
          ...
          aria-labelledby={`${list.id}-dropdown-button`}
         >
          <li>
           <button
            type="button"
