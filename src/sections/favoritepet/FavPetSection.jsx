...
const FavPetSection = () => {
 const { id } = useParams();
 const pet = favList.find((pet) => pet.id === id);
   ...
   <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0">
    <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
     <div className="shrink-0 max-w-md lg:max-w-lg mx-auto">
      <img
       className="w-60 rounded-lg dark:hidden"
       src={pet.src}
       alt={pet.label}
      />
     </div>
     ...
     <div className="mt-6 sm:mt-8 lg:mt-0">
      ...
      <p className="mb-6 text-gray-500 dark:text-gray-400">{pet.desc}</p>
     </div>
    </div>
   </div>
  </section>
